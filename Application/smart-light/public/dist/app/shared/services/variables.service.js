...
var VariablesService = /** @class */ (function () {
    ...
    function VariablesService() {
        this.login = false;
        this.navbarState = "nav-minimized";
        this.selectedMenu = "City Overview";
        this.disableMinimize = true;
        this.hidePassword = false;
        this.selctedSiteGateway = false;
        this.isFromOverview = false;
        /* this.dataChange = new Observable((observer:Observer) {
           this.dataChange = observer;
         });*/
    }
    VariablesService.prototype.setData = function (data) {
        this.data = data;
